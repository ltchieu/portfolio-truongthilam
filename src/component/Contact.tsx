...
export default function Contact() {
  return (
    <section
      id="lien-he"
      className="min-h-screen flex flex-col py-28 px-6 md:px-12 lg:px-16 bg-neutral-950 text-white rounded-t-[3.5rem] border-t border-neutral-900 shadow-[0_-20px_50px_rgba(0,0,0,0.15)] relative overflow-hidden"
    >
      ...
      <div className="max-w-6xl mx-auto flex-1 flex flex-col">
          ...
          <Grid size={{ xs: 12, sm: 6, md: 4 }}>
            ...
            >
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-sm font-semibold text-neutral-200 group-hover:text-rose-400 transition-colors whitespace-nowrap">
                  {CONTACT_INFO.email}
                </span>
              </div>
            </a>
        ...
        {/* Footer Copyright */}
        <div className="border-t border-white/10 mt-auto pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-neutral-500 gap-4">
