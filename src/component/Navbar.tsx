          ...
          <div className="flex flex-col gap-6">
            {navLinks.map((link, idx) => (
              <a
                ...
                className={`font-serif text-3xl font-bold tracking-tight text-neutral-800 dark:text-white hover:text-rose-500 transition-all duration-300 transform ${isOpen ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
                  }`}
